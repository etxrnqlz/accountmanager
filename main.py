...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        top.title('Input Master Password')
        top.geometry('{}x{}'.format(250, 100))
        top.resizable(width=False, height=False)
        self.l = Label(top, text="Master Password: ", font=('Courier', 12), justify=CENTER)
        self.l.pack()
...
entity_label = Label(window, text='Add Entities', font=('Courier', 18))
name_label = Label(window, text='Service: ', font=('Courier', 14))
...
submit = Button(window, text='Add Entity', command=onsubmit, font=('Courier', 14))
...
name_label2 = Label(window, text='Service: ', font=('Courier', 14))
